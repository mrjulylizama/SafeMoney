...
$sql="SELECT cantidad,categoria,descripcion,fecha  FROM egresos where id_usuario=$id AND fecha BETWEEN '$ini' AND '$fin' ORDER by fecha";
$result=mysqli_query($mysqli,$sql);
while($mostrar=mysqli_fetch_array($result))
    {
        $sheet->setCellValue('D'.$fila,'$'.$mostrar['cantidad']);  
        $sheet->setCellValue('E'.$fila,$mostrar['categoria']); 
    ...
    $nombreDelDocumento = "Egresos_de ".$ini." hasta ".$fin."_SafeMoney.xlsx";
/**
