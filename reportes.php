...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Creaccion de Reportes</a></li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <div class="col-sm-10">
      <hr>
              <h3 class="m-0">Crear reporte de Ingresos</h3>
              <hr>
              <form action="generaringreso.php" method="post">
              <label for="start">Desde</label>

                  <input type="date" id="start" name="fecha1"
                      value="2020-12-31"
                      min="2000-01-01" max="2022-12-31" require>

                      <label for="start">Hasta</label>

                  <input type="date" id="start" name="fecha2"
                  value="2021-12-31"
                      min="2000-03-22" max="2022-12-31" require>
            ...
            <div class="col-sm-10">
            <hr>
              <h3 class="m-0">Crear reporte de Egresos</h3>
              <hr>
              
              <form action="generaregreso.php" method="post">
              <label for="start">Desde</label>

                  <input type="date" id="start" name="fecha3"
                  value="2020-12-31"
                      min="2000-01-01" max="2022-12-31" require>

                      <label for="start">Hasta</label>

                  <input type="date" id="start" name="fecha4"
                  value="2021-12-31"
                      min="2000-03-22" max="2022-12-31" require>
                      <input type="submit" class="btn btn-primary"  value="Generar reporte" >
                    </form>
